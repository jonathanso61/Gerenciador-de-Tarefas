...
class AddTaskActivity : AppCompatActivity() {
    ...
    private fun loadTaskDetails(taskId: Long) {
        ...
        if (task != null) {
            // Se a tarefa existir, preencha os campos com seus detalhes
            editingTask = task // Mantenha a referência à tarefa sendo editada
            ...
            btnSaveTask.text = "Atualizar Tarefa" // Mude o texto do botão para refletir a edição
        }
    }
}
